<template>
    <section class="min-h-screen w-full" ref="skillsSection" id="skills-section">
        <div class="relative flex py-5 items-center"
            ...
            <h1 class="text-3xl font-bold pr-5">💪🤝 Habilidades e Competências </h1>
        ...
        <div
            ...
            <div class="order-2 xl:order-none">
                ...
                <ul
                    class="flow flow-col list-['\2705'] pl-6 sm:grid sm:grid-rows-1 sm:grid-cols-1 gap-x-4 overflow-y-auto max-h-48">
                    <li v-for="skill in content.softSkills" class="pl-3">{{ skill }}</li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul
                    class="flow flow-col list-['\2705'] pl-6 sm:grid sm:grid-rows-1 sm:grid-cols-1 gap-x-4 overflow-y-auto max-h-48">
                    <li v-for="skill in content.hardSkills" class="pl-3" style="word-break: break-word;" >{{ skill }}</li>
                </ul>
            </div>
        </div>
