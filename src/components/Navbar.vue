                ...
                <div :class="['transition-all motion-reduce:transition-none duration-500', showTransition ? 'opacity-1 blur-0' : 'opacity-0 blur-sm']">
                    ...
                    <div v-else>
                        <div class="flex items-center space-x-2 py-4 md:py-1 drop-shadow-lg bg-gradient-to-r from-[#fa3205] to-[#5301c5] bg-clip-text text-transparent">
                            <p>&lt;</p>
                            <p class="text-5xl md:text-7xl" id="custom-logo">L.B</p>
                            <p>/></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="hidden w-full xl:block xl:w-auto items-center" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 xl:p-0 mt-4 xl:flex-row xl:space-x-8 xl:mt-0">
                    <li :class="['transition-all motion-reduce:transition-none duration-500 delay-[50ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#about-section">Sobre</router-link>
                    </li>
                    <li :class="['transition-all motion-reduce:transition-none duration-500 delay-[100ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#experience-section">Experiencias</router-link>
                    </li>
                    <li :class="['transition-all motion-reduce:transition-none duration-500 delay-[100ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#skills-section">Habilidades</router-link>
                    </li>
                    <li :class="['transition-all motion-reduce:transition-none duration-500 delay-[150ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#work-section">Projetos</router-link>
                    </li>
                    <li :class="['transition-all motion-reduce:transition-none duration-500 delay-[200ms]', showTransition ? 'translate-y-0 opacity-1' : '-translate-y-4 opacity-0']">
                        <router-link class="block py-2 pl-3 pr-4 hover:text-link-color" to="/#contact-section">Contato</router-link>
                    </li>
        ...
        <NavTransition>
            <div v-show="dropDownActive" class="block w-full absolute xl:hidden px-9 pb-4 bg-white/[.9] dark:bg-black backdrop-blur-sm">
                <ul>
                    ...
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#experience-section">🛡️ Experiencias</router-link>
                    </li>
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#work-section">💻 Projetos</router-link>
                    </li>
                    <li>
                        <router-link class="block py-5  hover:text-link-color" to="/#contact-section">📭 Contato</router-link>
                    </li>
                    <li>
                        <a :href="portfolio.greeting.resumeLink" target="_blank">
                            <button class="block w-full text-center bg-button-color py-2 px-6 mt-5 shadow-sm shadow-button-color focus:bg-button-color focus:text-white active:bg-button-color active:text-white text-white">Curriculo</button>
                        </a>
                    </li>
                    <li>
